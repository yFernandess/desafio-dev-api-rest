...
from app.interfaces.account import AccountInterface, RequestBlockAccountInterface, RequestCreateAccountInterface
from app.interfaces.account_owner import AccountOwnerInterface, RequestCreateAccountOwnerInterface, RequestRemoveAccountOwnerInterface
...
class AccountService:
    ...
    async def block_account(self, payload: RequestBlockAccountInterface):
        try:
            ...
            account_owner_updated = await self.account_repository.block_account(
                account_id=payload.account_id,
                state=AccountStates.BLOCKED.value,
            )

            return account_owner_updated
        except Exception as e:
